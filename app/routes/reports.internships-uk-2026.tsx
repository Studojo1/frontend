              ...
              <div>
                ...
                <div className="rpt-card" style={{ padding: 20 }}>
                  ...
                  <div className="rpt-mini-total" style={{ background: "#fee2e2", border: "1px solid #ef4444" }}>
                    ...
                    <div style={{ fontSize: 12, color: "#525252", marginTop: 4, lineHeight: 1.6 }}>You are legally a worker. You are entitled to National Minimum Wage for every hour worked. HMRC can investigate and the employer can be named publicly.</div>
                  </div>
                </div>
              </div>
              <div>
                ...
                <div className="rpt-card" style={{ padding: 20 }}>
                  ...
                  <div className="rpt-mini-total" style={{ background: "#d0fae4", border: "1px solid #10b981" }}>
                    ...
                    <div style={{ fontSize: 12, color: "#525252", marginTop: 4, lineHeight: 1.6 }}>The vast majority of "unpaid internships" at businesses fail this test. If you are doing real work, you should be paid.</div>
                  </div>
                </div>
              </div>
            </div>
