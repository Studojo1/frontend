    ...
    <div className="min-h-screen bg-white text-studojo-ink font-satoshi">
      ...
      <section className="max-w-6xl mx-auto px-5 pt-14 pb-8">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          <a href="/reference" className="font-bold px-5 py-2.5 rounded-xl border-2 border-neutral-900 shadow-[3px_3px_0_0_#171717] hover:translate-y-0.5 transition bg-studojo-green text-neutral-900">
