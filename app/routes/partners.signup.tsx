...
import { partnersPost, setToken, setStoredUser } from "~/lib/partners/api";
import type { Route } from "./+types/partners.signup";

export function meta({}: Route.MetaArgs) {
  return [{ title: "Sign Up | Studojo Partners" }];
}
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-neutral-50 font-['Satoshi'] px-4 py-16">
      <div className="w-full max-w-md">
        {/* Logo */}
        <Link to="/partners" className="mb-8 block text-center font-['Clash_Display'] text-2xl font-bold text-neutral-900">
          Studojo Partners
        </Link>
        ...
        <div className="rounded-2xl border-2 border-neutral-900 bg-white p-8 shadow-[6px_6px_0px_0px_rgba(25,26,35,1)]">
          ...
          <p className="mb-6 text-sm text-neutral-500">
            Already have one?{" "}
            <Link to="/partners/login" className="font-semibold text-violet-600 underline">
              Sign in
            </Link>
          </p>
