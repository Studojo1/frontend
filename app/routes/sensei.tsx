      ...
      <main className="min-h-screen bg-white">
        ...
        <Section className="mx-auto py-16 md:py-20">
          ...
          >
            <motion.h2
              variants={fadeUp}
              className="font-['Clash_Display'] text-3xl font-medium leading-tight text-neutral-900 md:text-4xl"
            >
            ...
            <motion.p
              variants={fadeUp}
              className="mt-6 font-['Satoshi'] text-lg leading-7 text-neutral-600"
            >
        ...
        {/* ── Capabilities ─────────────────────────────────────────────── */}
        <section className="border-y border-neutral-900 bg-neutral-50 py-16 md:py-20">
            ...
            >
              {CAPABILITIES.map((c) => (
                <motion.div
                  key={c.title}
                  variants={fadeUp}
                  className="rounded-3xl border-2 border-neutral-900 bg-white p-7 shadow-[6px_6px_0px_0px_rgba(25,26,35,1)]"
                >
                  <div className={`mb-5 inline-flex h-12 w-12 items-center justify-center rounded-2xl border-2 border-neutral-900 ${c.iconBg}`}>
                    <c.icon className="text-neutral-900" size={20} />
                  </div>
        ...
        <Section className="mx-auto py-16 md:py-20">
          ...
          >
            <motion.h2
              variants={fadeUp}
              className="text-center font-['Clash_Display'] text-3xl font-medium text-neutral-900 md:text-4xl"
            >
            ...
            <div className="mt-12 grid gap-6 md:grid-cols-3">
              {STEPS.map((s) => (
                <motion.div key={s.n} variants={fadeUp} className="relative">
                  <div className="font-['Clash_Display'] text-5xl font-medium text-violet-200">
                    {s.n}
                  </div>
                  <h3 className="mt-2 font-['Clash_Display'] text-xl font-medium text-neutral-900">
                    {s.title}
                  </h3>
                  <p className="mt-3 font-['Satoshi'] text-[15px] leading-7 text-neutral-600">
                    {s.body}
        ...
        {/* ── Pricing honesty ──────────────────────────────────────────── */}
        <section className="border-y border-neutral-900 bg-violet-500 py-16 md:py-20">
          <Section width="narrow" className="mx-auto text-center">
            <motion.div
              variants={stagger}
              initial="hidden"
            ...
            >
              ...
              <motion.h2
                variants={fadeUp}
                className="font-['Clash_Display'] text-3xl font-medium text-white md:text-4xl"
              >
                You pay for contacts we actually find
              </motion.h2>
              <motion.p
                variants={fadeUp}
                className="mx-auto mt-6 max-w-2xl font-['Satoshi'] text-lg leading-7 text-violet-100"
              >
        ...
        {/* ── Demo form ────────────────────────────────────────────────── */}
        <Section id="demo" className="mx-auto py-16 md:py-20">
          <div className="mx-auto grid max-w-5xl gap-10 md:grid-cols-2">
            ...
            >
              ...
              <motion.p
                variants={fadeUp}
                className="mt-5 font-['Satoshi'] text-[15px] leading-7 text-neutral-600"
              >
