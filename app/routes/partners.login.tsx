...
import type { Route } from "./+types/partners.login";

export function meta({}: Route.MetaArgs) {
  return [{ title: "Sign In | Studojo Partners" }];
}
      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border-2 border-neutral-900 bg-white p-8 shadow-[6px_6px_0px_0px_rgba(25,26,35,1)]">
          ...
          <p className="mb-6 text-sm text-neutral-500">
            New here?{" "}
            <Link to="/partners/signup" className="font-semibold text-violet-600 underline">
              Create an account
            </Link>
          </p>
