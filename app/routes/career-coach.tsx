    ...
    <main className="mx-auto max-w-[var(--section-max-width)] px-4 py-16 md:px-8 md:py-24">
      ...
      >
        ...
        <div className="inline-flex items-center gap-2 rounded-full border border-neutral-200 bg-neutral-50 px-4 py-1.5">
          ...
          <span className="font-['Satoshi'] text-sm font-medium text-neutral-600">AI Career Coach · Beta</span>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="max-w-xl font-['Satoshi'] text-lg leading-relaxed text-neutral-500 md:text-xl">
            CareerDojo analyses your profile, finds the gaps, and gives you a week-by-week plan to get hired — no fluff, no generic advice.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
          <a
            ...
            className="inline-flex h-14 items-center justify-center rounded-2xl bg-neutral-900 px-8 font-['Satoshi'] text-base font-medium text-white transition-transform hover:translate-x-[2px] hover:translate-y-[2px]"
          >
            Start your career analysis →
          </a>
          <span className="font-['Satoshi'] text-sm text-neutral-400">Free · No sign-up needed</span>
        </div>
          ...
          {[
            {
              icon: "🧬",
              title: "Career DNA",
              desc: "A single readiness score built from your skills, gaps, and target role — personalised to India's job market.",
            },
            {
              icon: "📍",
              title: "Gap Analysis",
            ...
            },
            {
              ...
              desc: "Prioritised actions you can take this week — linked directly to Resume Maker and Outreach Dojo.",
            },
          ].map(({ icon, title, desc }) => (
            <div
              key={title}
            ...
            >
              ...
              <h3 className="font-['Satoshi'] text-base font-bold text-neutral-900">{title}</h3>
              <p className="font-['Satoshi'] text-sm leading-relaxed text-neutral-500">{desc}</p>
            </div>
          ))}
        </div>
      </motion.div>
