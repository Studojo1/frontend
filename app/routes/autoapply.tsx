                ...
                {showCampaignForm && (
                  <div className="mb-4 rounded-xl border-2 border-violet-200 bg-violet-50 p-4 space-y-3">
                    <input value={newCampaignName} onChange={(e) => setNewCampaignName(e.target.value)}
                      ...
                      className="w-full rounded-lg border-2 border-neutral-900 px-3 py-2 font-['Satoshi'] text-base focus:outline-none focus:ring-2 focus:ring-violet-500" />
          ...
          <>
            ...
            {step === "resume" && (
              <div className="rounded-2xl border-2 border-neutral-900 bg-white p-6 shadow-[4px_4px_0px_0px_rgba(25,26,35,1)] md:p-8">
                ...
                <textarea value={cvText} onChange={(e) => setCvText(e.target.value)} placeholder="Or paste CV text here..." rows={10} className="w-full resize-none rounded-xl border-2 border-neutral-900 bg-white px-4 py-3 font-['Satoshi'] text-base placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-violet-500" />
              ...
              <div className="rounded-2xl border-2 border-neutral-900 bg-white p-6 shadow-[4px_4px_0px_0px_rgba(25,26,35,1)] md:p-8 space-y-5">
                ...
                {sessionSaved ? (
                  ...
                  <>
                    ...
                    <input type="password" value={liAt} onChange={(e) => setLiAt(e.target.value)} placeholder="AQEDATKr... (paste li_at)" className="w-full rounded-xl border-2 border-neutral-900 px-4 py-3 font-mono text-base placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-violet-500" />
