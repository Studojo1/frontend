  ...
  return (
    <div className="min-h-[calc(100vh-80px)] bg-gradient-to-br from-violet-50 via-white to-amber-50 flex items-center justify-center px-6 py-16">
      <div className="max-w-3xl w-full">
        ...
        <button
          onClick={onStart}
          className="inline-flex items-center gap-2 px-7 py-4 bg-violet-500 text-neutral-900 font-bold text-lg border-2 border-neutral-900 rounded-2xl shadow-[6px_6px_0px_0px_rgba(25,26,35,1)] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_0px_rgba(25,26,35,1)] transition-all font-['Satoshi']"
        >
          Start building
