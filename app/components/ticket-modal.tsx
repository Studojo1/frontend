        ...
        {createdId ? (
          ...
          <>
            ...
            <textarea
              ...
              maxLength={5000}
              className="w-full rounded-lg border-2 border-neutral-900 bg-white px-3 py-2 text-base text-neutral-900 placeholder:text-neutral-400 focus:outline-none resize-none"
            />
