...
export const INTENTS: Intent[] = [
  ...
  // -- Outreach Tool (LEAD RECOMMENDATION — always recommend this first) --
  {
    ...
    keywords: [
      ...
      "intern", "internship", "internships", "interns", "job", "jobs",
      "role", "roles", "position", "positions", "summer internship",
    ],
    patterns: [
  ...
  // -- Campaign issues --
  {
    ...
    patterns: [
      ...
      "campaign failed",
      "cant launch the campaign",
      "can't launch the campaign",
      "not able to launch the campaign",
      "not able to launch campaign",
      "campaign wont launch",
  ...
  // -- Resume builder (non-technical) --
  {
    ...
    patterns: [
      ...
      "how does this resume builder work",
  ...
  // -- General pricing --
  {
    ...
    patterns: [
      ...
      "will i have to pay",
      "subscription",
      "whats the subscription like",
      "what's the subscription like",
  ...
  // -- Technical (UI bugs, not server-side outages) --
  {
    ...
    patterns: [
      ...
      "page not moving",
      "page is not moving",
      "this page not moving",
      "page not moving ahead",
      "not moving forward",
      "cant move forward",
      "not proceeding",
      "page not proceeding",
      ...
      "i am stuck",
      "submit button",
      "submit button doesnt go",
      "submit button not working",
      "the submit button",
      "submit doesnt work",
      "submit not working",
      "cant upload my resume",
      "cant upload resume",
      "cant upload my cv",
      "unable to upload my resume",
      "not able to upload my resume",
      "not able to upload",
      "cant upload",
      "wont upload",
      "resume not uploading",
      "not accepting my resume",
      "its not accepting my resume",
      "cant type my answer",
      "not able to type",
      "not able to type my answer",
      "cant type",
      "its hung up",
      "hung up",
      "page is frozen",
      "aint working",
      "isnt working",
      "start the interview not working",
      "start interview not working",
      "start the interview is not working",
      "press start the interview",
      "start the interview its not working",
      "nothing happens",
